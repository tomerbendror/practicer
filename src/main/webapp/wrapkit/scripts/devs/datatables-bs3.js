(function (factory) {
	...
	$.extend( true, $.fn.dataTable.defaults, {
		...
		"oLanguage": {
			"sIconClassFirst": "fa fa-double-angle-left",
			"sIconClassLast": "fa fa-double-angle-right",
			"sIconClassPrevious": "fa fa-angle-left",
			"sIconClassNext": "fa fa-angle-right"
		},
		"language": {
	...
	if ( $.fn.DataTable.TableTools ) {
		...
		$.extend( true, $.fn.DataTable.TableTools.classes, {
			"container": "DTTT btn-group btn-group-sm clearfix",
			"buttons": {
